-- =====================================================
-- SETUP TABEL BERITA DAN ABOUT - CEPATCOPY JWP
-- =====================================================
...
('Layanan Fotokopi Berkualitas Tinggi', 'Kami menyediakan layanan fotokopi dengan kualitas tinggi menggunakan mesin fotokopi terbaru. Hasil fotokopi yang jelas dan rapi untuk memenuhi kebutuhan dokumen Anda.', 'published'),
('Promo Spesial Bulan Ini', 'Dapatkan diskon 10% untuk fotokopi dokumen dalam jumlah besar. Promo berlaku hingga akhir bulan ini. Hubungi kami untuk informasi lebih lanjut.', 'published'),
('Layanan Digital Printing', 'Selain fotokopi, kami juga menyediakan layanan digital printing untuk banner, spanduk, dan media promosi lainnya. Kualitas terbaik dengan harga terjangkau.', 'published');

-- =====================================================
-- SELESAI SETUP TABEL BERITA DAN ABOUT
-- ===================================================== 